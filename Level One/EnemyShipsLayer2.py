...
# Total enemy ships
# Ship one
EnemyShipOne = pygame.image.load("Spaceship-Transparent-PNG.png").convert()
EnemyShipOne = pygame.transform.scale(EnemyShipOne, (80,80))
# Ship Two
EnemyShipTwo = pygame.image.load("Spaceship-Transparent-PNG.png").convert()
EnemyShipTwo = pygame.transform.scale(EnemyShipTwo, (80,80))
# Ship Three
EnemyShipThree = pygame.image.load("Spaceship-Transparent-PNG.png").convert()
EnemyShipThree = pygame.transform.scale(EnemyShipThree, (80,80))
# Ship Four
EnemyShipFour = pygame.image.load("Spaceship-Transparent-PNG.png").convert()
EnemyShipFour = pygame.transform.scale(EnemyShipFour, (80,80))
# Ship Five
EnemyShipFive = pygame.image.load("Spaceship-Transparent-PNG.png").convert()
EnemyShipFive = pygame.transform.scale(EnemyShipFive, (80,80))
# Ship Six
EnemyShipSix = pygame.image.load("Spaceship-Transparent-PNG.png").convert()
